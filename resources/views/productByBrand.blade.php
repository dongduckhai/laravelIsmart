                            ...
                            <div class="form-filter">
                                <form action="#">
                                    <select name="sort">
                                        ...
                                        <option value="1"
                                            {{ request()->input('sort') == 1 ? "selected='selected'" : '' }}>Dưới 5 triệu
                                        </option>
                                        <option value="2"
                                            {{ request()->input('sort') == 2 ? "selected='selected'" : '' }}>Từ 5 - 10
                                            triệu</option>
                                        <option value="3"
                                            {{ request()->input('sort') == 3 ? "selected='selected'" : '' }}>Từ 10 - 20
                                            triệu</option>
                                        <option value="4"
                                            {{ request()->input('sort') == 4 ? "selected='selected'" : '' }}>Trên 20 triệu
                                        </option>
                                    </select>
                                    ...
                                    <li class="h-308">
                                        ...
                                        data-url="{{ route('cart.ajax',$product->id) }}">
                                            ...
                                            <a href="{{ route('product.details', $product->id) }}"
                                                title="Thông tin chi tiết" class="buy-now fl-right">Thông tin</a>
                                        </div>
                                    </li>
                                @endforeach
                        </ul>
                            ...
                            @foreach ($hot_products as $hot_product)
                                <li class="clearfix">
                                    ...
                                    <div class="info fl-right">
                                        ...
                                        <a href="{{ route('cart.add', $hot_product->id) }}" title="Mua ngay"
